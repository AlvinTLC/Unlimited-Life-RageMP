...
var editing_types = ["Sinken: по X", "Sinken: Y", "Höhe", "Erhöhung: X", "Erhöhung: Y", "Drehen"];
...
mp.events.add('render', () => {
    if (object !== null) {
        ...
        AddInstructionalButtonCustom("Geschwindigkeit verringern", "t_-");
        AddInstructionalButtonCustom("Anwenden", "t_Y");
        AddInstructionalButtonCustom("Abbrechen", "t_N");
