$(document).ready(() => {
    var modals = {
        ...
        "item_throw_ground": {
            header: "Выкидывание предмета",
            location: "center",
            content: `Предмет: <a style="color: green;" class="balance_bank"></a><br/><br/>
                        <span>Введите количество:</span>
                        <input type="text" class="mbank_put"/>
                        <br/><br/>
                        <center><button>Выкинуть</button></center>`,
            on: (values) => {
                inventoryAPI.closeMenu();
                setOnlyInt(".modal .mbank_put");
                var handler = () => {
                    var money = $(".modal .mbank_put").val().trim();
                    if (!money) return lightTextFieldError(".modal .mbank_put", `Неверное количество!`);
                    if (money < 1) return lightTextFieldError(".modal .mbank_put", `Неверное количество!`);
          					if (!isFlood()) {
          						mp.trigger("item.throwOnGround", values.sqlId, money);
          						modalAPI.hide();
          					}
                };
                $(".modal .balance_bank").text(`${values.item}`);
        ...
        "pass_money_player": {
            header: "Передача денег", // Вывод средств
            location: "center",
            content: `Вы передаете деньги <a style="color: green;" class="balance_bank">Vlad Garashenko</a><br/><br/>
                        <span>Введите сумму:</span>
                        <input type="text" class="mbank_put"/>
                        <br/><br/>
                        <center><button>Передать</button></center>`,
            on: (values) => {
                setOnlyInt(".modal .mbank_put");
                var handler = () => {
                    var money = $(".modal .mbank_put").val().trim();
                    mp.trigger("pass.player.money", money, values.interactionId);
                };
                $(".modal .balance_bank").text(`${values.target}`);
                $(".modal .mbank_put").on("keydown", (e) => {
                    if (e.keyCode == 13) handler();
                });
                $(".modal button").on("click", () => {
        ...
        "gang_money_put": {
            ...
            on: (values) => {
                ...
                var handler = () => {
                    var money = $(".modal .mbank_put").val().trim();
                    mp.trigger("gang.put.money", money);
                };
                $(".modal .balance_bank").text(`$${values.money}`);
                $(".modal .mbank_put").on("keydown", (e) => {
                    if (e.keyCode == 13) handler();
        ...
        "gang_money_take": {
            header: "Вывод из сейфа", // Вывод средств
            location: "center",
            content: `Баланс <a style="color: green;" class="balance_bank"></a><br/><br/>
                        <span>Введите сумму:</span>
                        <input type="text" class="mbank_take"/>
            ...
            on: (values) => {
                ...
                var handler = () => {
                    var money = $(".modal .mbank_take").val().trim();
                    mp.trigger("gang.take.money", money);
                };
                $(".modal .balance_bank").text(`$${values.money}`);
                $(".modal .mbank_take").on("keydown", (e) => {
                    if (e.keyCode == 13) handler();
        ...
        "allow_gang_menu0": {
            header: "Доступ к оружию",
            location: "center",
            content: `Текущий ранг: <a style="color: yellow;" class="balance_bank"></a><br/><br/>
                        <span>Введите новый ранг:</span>
                        <input type="text" class="mbank_put"/>
                        <br/><br/>
                        <center><button>Изменить</button></center>`,
            on: (values) => {
                setOnlyInt(".modal .mbank_put");
                var handler = () => {
                    var count = $(".modal .mbank_put").val().trim();
                    mp.trigger("gang.control.allow", 0, count);
                };
                $(".modal .balance_bank").text(`${values.rank}`);
                $(".modal .mbank_put").on("keydown", (e) => {
                    if (e.keyCode == 13) handler();
                });
                $(".modal button").on("click", () => {
        ...
        "allow_gang_menu1": {
            ...
            on: (values) => {
                ...
                var handler = () => {
                    var count = $(".modal .mbank_put").val().trim();
                    mp.trigger("gang.control.allow", 1, count);
                };
                $(".modal .balance_bank").text(`${values.rank}`);
                $(".modal .mbank_put").on("keydown", (e) => {
                    if (e.keyCode == 13) handler();
        ...
        "allow_gang_menu2": {
            ...
            on: (values) => {
                ...
                var handler = () => {
                    var count = $(".modal .mbank_put").val().trim();
                    mp.trigger("gang.control.allow", 2, count);
                };
                $(".modal .balance_bank").text(`${values.rank}`);
                $(".modal .mbank_put").on("keydown", (e) => {
                    if (e.keyCode == 13) handler();
        ...
        "allow_gang_menu3": {
            ...
            on: (values) => {
                ...
                var handler = () => {
                    var count = $(".modal .mbank_put").val().trim();
                    mp.trigger("gang.control.allow", 3, count);
                };
                $(".modal .balance_bank").text(`${values.rank}`);
                $(".modal .mbank_put").on("keydown", (e) => {
                    if (e.keyCode == 13) handler();
        ...
        "gang_drugs_put": {
            header: "Пополнение наркотиков",
            location: "center",
            content: `<a class="drug_name"></a> - <a style="color: green;" class="balance_bank"></a><br/><br/>
                        <span>Введите количество:</span>
                        <input type="text" class="mbank_put"/>
                        <br/><br/>
                        <center><button>Положить</button></center>`,
            on: (values) => {
                setOnlyInt(".modal .mbank_put");
                var handler = () => {
                    var count = $(".modal .mbank_put").val().trim();
                    mp.trigger("gang.control.drugs", count, values.id, values.type);
                };
                $(".modal .balance_bank").text(`${values.count}`);
                $(".modal .drug_name").text(`${values.drug_name}`);
                $(".modal .mbank_put").on("keydown", (e) => {
                    if (e.keyCode == 13) handler();
                });
                $(".modal button").on("click", () => {
        ...
        "gang_drugs_take": {
            header: "Склад наркотиков",
            location: "center",
            content: `<a class="drug_name"></a> - <a style="color: green;" class="balance_bank"></a><br/><br/>
                        <span>Введите количество:</span>
                        <input type="text" class="mbank_put"/>
                        <br/><br/>
                        <center><button>Взять</button></center>`,
            on: (values) => {
                setOnlyInt(".modal .mbank_put");
                var handler = () => {
                    var count = $(".modal .mbank_put").val().trim();
        ...
        "gang_ammo_put": {
            ...
            on: (values) => {
                ...
                var handler = () => {
                    var count = $(".modal .mbank_put").val().trim();
                    mp.trigger("gang.control.ammo", count, values.id, values.type);
                };
                $(".modal .balance_bank").text(`${values.count}`);
                $(".modal .drug_name").text(`${values.drug_name}`);
                $(".modal .mbank_put").on("keydown", (e) => {
