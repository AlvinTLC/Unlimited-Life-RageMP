    ...
    if (index == -1) {
        ...
        switch (circleTitle) {
            ...
            case "Игрок":
                ...
                switch (index) {
                    case 0:
                        mp.events.callRemote('pSelected', entity, "Geld geben");
                        return;
                    case 1:
                        mp.events.callRemote('pSelected', entity, "Handeln");
                        return;
                    case 2:
                    ...
                    case 4:
                        ...
                        return;
                    case 5:
                        mp.events.callRemote('pSelected', entity, "Heilen");
                        return;
                    case 6:
                        OpenCircle("Дом", 0);
                        return;
                    case 7:
                        mp.events.callRemote('pSelected', entity, "Hände schütteln");
                        return;
                }
                return;
            case "Дом":
                switch (index) {
                    case 0:
                        mp.events.callRemote('pSelected', entity, "Auto Verkaufen");
                        return;
                    case 1:
                        mp.events.callRemote('pSelected', entity, "Haus Verkaufen");
                        return;
                    case 2:
                        mp.events.callRemote('pSelected', entity, "ins Haus Gehen");
                        return;
                    case 3:
                        mp.events.callRemote('pSelected', entity, "ins Haus einladen");
                        return;
                }
                return;
            case "Фракция":
