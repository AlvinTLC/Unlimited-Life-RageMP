...
spmenu.Close();
spmenu.AddItem(new UIMenuListItem("Spectate", "Nächster Spieler по ID",  new ItemsCollection(["Previous", "Next"])));
spmenu.AddItem(new UIMenuItem("Refresh", "Tracking des aktuellen Spielers aktualisieren"));
spmenu.AddItem(new UIMenuItem("Unspectate", "Spectate verlassen"));
