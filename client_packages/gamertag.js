                    ...
                    if (_player.getVariable('INVISIBLE') != true && _player.getVariable('HideNick') != true) {
                        ...
                        if (tagLabelPool[_player.remoteId] === undefined || reupdateTagLabel[_player.remoteId] === undefined || new Date().getTime() - reupdateTagLabel[_player.remoteId] > 500) {
                            ...
                            if (_player.getVariable('IS_MASK') == true) 
                            {
                                ...
                                {
                                     text = (_player.getVariable('IS_ADMIN') === true && _player.getVariable('REDNAME') === true) ? ' Administrator (' + _player.remoteId + passportText + ')' : 'Игрок в маске: ' + _player.name + ' (' + _player.remoteId + passportText + ')';
                                }
                                else
                                {
                                     text = 'Незнакомец (' + _player.remoteId+')';
                                }
                            } 
                            else 
                            {
                                ...
                                {
                                text = (_player.getVariable('IS_ADMIN') === true && _player.getVariable('REDNAME') === true) ? ' Administrator (' + _player.remoteId + passportText + ')' : _player.name + ' (' + _player.remoteId + passportText + ')';
                                }
                                else
                                {
                                 text = 'Незнакомец (' + _player.remoteId+')';
                      ...
                      /*      if (_player.getVariable('IS_MASK') == true) {
                                if (isAdmin === true) text = '\u0418\u0433\u0440\u043E\u043A \u0432 \u043C\u0430\u0441\u043A\u0435: ' + _player.name + ' (' + _player.remoteId + passportText + ')';else text = 'Незнакомец  ID: (' + _player.remoteId+')';
                            } else {
                                if (isAdmin === true || mp.storage.data.friends[_player.name] !== undefined || global.passports[_player.name] !== undefined) text = _player.name + ' (' + _player.remoteId + passportText + ')';else text = '`Незнакомец  ID: (' + _player.remoteId+')';
                            }*/
