...
spmenu.Close();
spmenu.AddItem(new UIMenuListItem("Spectate", "Umschalten der Player-IDs",  new ItemsCollection(["Previous", "Next"])));
spmenu.AddItem(new UIMenuItem("Refresh", "Tracking des aktuellen Spielers aktualisieren"));
spmenu.AddItem(new UIMenuItem("Unspectate", "Spectate deaktivieren"));
