...
const houseClasses = [
  ...
  hclass(2, "Econom+", "Ну, так себе", 2),
  hclass(3, "Comfort", "Уже неплохо", 4),
  hclass(4, "Comfort+", "А ты двигаешься", 5),
  hclass(5, "Premium", "Ого, ничего себе", 6),
  hclass(6, "Premium+", "Я еле сдерживаю эмоции", 8),
]
