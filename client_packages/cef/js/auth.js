...
var slots = new Vue({
    ...
    data: {
        server: 0,
        slotL: ["RickardoS", "Salvadoro", 7, 10, 36, "LostCost", 100398, 1600000],
        slotM: ["Rickardo", "Salvadoro", 7, 10, 36, "LostCost", 100398, 1600000],
        slotR: ["Rickardo", "Salvadoro", 7, 10, 36, "LostCost", 100398, 1600000],
        blockL: ["Der Staat braucht einen neuen Helden schau rein", "Future_day", "more me money", "cash in da house"],
        blockM: ["Der Staat braucht einen neuen Helden, schau rein", "Future_day", "more me money", "cash in da house"],
        blockR: ["Der Staat braucht einen neuen Helden, schau rein", "Future_day", "more me money", "cash in da house"],
        ulifecoins: -1,
        login: "username",
    },
})
...
function toslots(data) {
    ...
    if (data[0] == -1) {
        ...
        if (data[0][0] == 'ban') {
            ...
            slotL.addClass('active mini-active');
        }
    }
    ...
    if (data[1] == -1) {
        ...
        if (data[1][0] == 'ban') {
            ...
            slotM.addClass('active mini-active');
        }
    }
    ...
    if (data[2] === -1) {
        ...
        if (data[2][0] == 'ban') {
            ...
            slotR.addClass('active mini-active');
        }
    }
...
$(document).ready(() => {
    ...
    endRestoreBtn.on('click', (e) => {
        ...
        if (!restPassState) {
            ...
            if (myval.length != 0) {
                restPassState = true;
                restPass.attr('placeholder', 'Der Code aus dem Brief');
                restPass.val('');
    ...
    $('.mini-active__wrapper').on('click', function() {
        let select_id = $(this).data('select-id');
        console.log(`Жмяк`)
        $('.active__wrapper').hide();
        $('.info-block-' + select_id).show();
        return false;
    });
});