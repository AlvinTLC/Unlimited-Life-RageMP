        ...
        inserted: function (e, t, n, r) {
            "select" === n.tag
                ...
                : ("textarea" === n.tag || Xn(e.type)) &&
                  ((e._vModifiers = t.modifiers), t.modifiers.lazy || (e.addEventListener("compositionstart", Zi), e.addEventListener("compositionend", Gi), e.addEventListener("change", Gi), W && (e.vmodel = !0)));
        },
                        ...
                        if (((e.hasBindings = !0), (a = ha(r.replace(Go, ""))) && (r = r.replace(ra, "")), na.test(r)))
                            (r = r.replace(na, "")),
                                ...
                                a &&
                                    ...
                                    a.sync &&
                                        ((s = Br(o, "$event")),
                                        c ? Mr(e, '"update:"+(' + r + ")", s, null, !1, 0, u[t], !0) : (Mr(e, "update:" + b(r), s, null, !1, 0, u[t]), C(r) !== b(r) && Mr(e, "update:" + C(r), s, null, !1, 0, u[t])))),
