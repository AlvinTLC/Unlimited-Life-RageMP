!(function (t, e) {
    ...
    return (function (t) {
        ...
        function (t, e, n) {
            ...
            function h() {
                ...
                void 0 !== document.hidden
                    ...
                    : void 0 !== document.webkitHidden && ((s = "webkitHidden"), (a = "webkitvisibilitychange")),
                    a && u(document, a, t),
                    u(window, "blur", e),
                    u(window, "focus", n);
            }
                ...
                (e.css = (function () {
                    ...
                    return function (t, e) {
                        var n = arguments,
                            i = void 0,
                            r = void 0;
                        if (2 === n.length) for (i in e) e.hasOwnProperty(i) && void 0 !== (r = e[i]) && e.hasOwnProperty(i) && o(t, i, r);
                        else o(t, n[1], n[2]);
                    };
                })());
        },
        function (t, e, n) {
            ...
            function i(t) {
                E.hasOwnProperty(t.options.queue) || (E[t.options.queue] = { maxVisible: x, queue: [] }), E[t.options.queue].queue.push(t);
            }
            function r(t) {
            ...
            function v(t) {
                t.options.timeout &&
                    (t.options.progressBar && t.progressDom && k.css(t.progressDom, { transition: "width " + t.options.timeout + "ms linear", width: "0%" }),
            ...
            function y(t) {
                t.options.timeout && t.closeTimer && (clearTimeout(t.closeTimer), (t.closeTimer = -1), t.options.progressBar && t.progressDom && k.css(t.progressDom, { transition: "width 0ms linear", width: "100%" }));
            }
            function b(t, e) {
            ...
            e.Defaults = {
                ...
                container: !1,
                buttons: [],
                callbacks: { beforeShow: null, onShow: null, afterShow: null, onClose: null, afterClose: null, onClick: null, onHover: null, onTemplate: null },
            ...
            e.Push = (function () {
                function t() {
                    ...
                    return (
                        ...
                        (this.subData = {}),
                        (this.workerPath = e),
                        (this.listeners = { onPermissionGranted: [], onPermissionDenied: [], onSubscriptionSuccess: [], onSubscriptionCancel: [], onWorkerError: [], onWorkerSuccess: [], onWorkerNotSupported: [] }),
                        this
                    );
                }
                return (
                            ...
                            value: function () {
                                ...
                                if (window.Notification && window.Notification.permissionLevel) t = window.Notification.permissionLevel;
                                    ...
                                    window.Notification && window.Notification.permission
                                        ...
                                        ? (t = "granted")
                                        : window.external && void 0 !== window.external.msIsSiteMode() && (t = window.external.msIsSiteMode() ? "granted" : "default");
                            ...
                            value: function () {
                                ...
                                "default" === o
                                    ? window.Notification && window.Notification.requestPermission
                                        ...
                                        : window.webkitNotifications && window.webkitNotifications.checkPermission && window.webkitNotifications.requestPermission(i)
                                    : i(o);
                            },
                        },
                    ]),
                        ...
                        (this._instanceConstructor = t),
                            ...
                            F(e)
                                ? ((this.length = e.length),
                                  ...
                                  0 === this.length ? k(this.promise, this._result) : ((this.length = this.length || 0), this._enumerate(e), 0 === this._remaining && k(this.promise, this._result)))
                                : C(this.promise, q());
                    }
                    function q() {
                        ...
                        return (
                            ...
                            d.Store[this.options.id]
                                ...
                                : ((this.id = this.options.id || c.generateID("bar")),
                                  ...
                                  (this.soundPlayed = !1),
                                  (this.listeners = { beforeShow: [], onShow: [], afterShow: [], onClose: [], afterClose: [], onClick: [], onHover: [], onTemplate: [] }),
                                    ...
                                    value: function () {
                                        ...
                                        return (
                                            ...
                                            null === this.options.animation.open
                                                ...
                                                ? (this.promises.show = new u.default(this.options.animation.open.bind(this)))
                                ...
                                },
                                {
                                    ...
                                    value: function () {
                                        ...
                                        return this.closed
                                            ...
                                            ? (d.fire(this, "onClose"),
                                              (this.closing = !0),
                                              null === this.options.animation.close || !1 === this.options.animation.close
                                                  ? (this.promises.close = new u.default(function (t) {
                                                        t();
                                                    }))
                                                  : "function" == typeof this.options.animation.close
                                                  ? (this.promises.close = new u.default(this.options.animation.close.bind(this)))
                            ...
                            [
                                ...
                                },
                                {
                                    ...
                                    value: function () {
                                        ...
                                        return d.Queues.hasOwnProperty(e) || (d.Queues[e] = { maxVisible: t, queue: [] }), (d.Queues[e].maxVisible = t), this;
                                    },
                                },
                                {
                                    key: "button",
