    ...
    function (e, t, s) {
        ...
        class l {
            ...
            Draw(e, t, s, i, n, h, o) {
                (e = e || this.TextureDict),
                    ...
                    (n = n || this.heading),
                    (h = h || this.color),
                    (o = o || !0) && (mp.game.graphics.hasStreamedTextureDictLoaded(e) || mp.game.graphics.requestStreamedTextureDict(e, !0));
            ...
            Draw(e, t, s, i, n, h, r, a, l) {
                ...
                e || (e = new m(0, 0)),
                    e &&
                        ...
                        (i = this.color),
                        (n = this.font),
                        1 == d || 0 == d ? (d = this.centered) : ((d = void 0), (r = this.DropShadow), (a = this.Outline), (l = this.WordWrap)));
        ...
        class I {
            constructor(e, t = "") {
                (this.BackColor = I.DefaultBackColor),
                    ...
                    (this.Enabled = !0),
                    (this._rectangle = new f(new u(0, 0), new m(431, 38), new a(150, 0, 0, 0))),
                    (this._text = new p(e, new u(8, 0), 0.33, a.WhiteSmoke, r.ChaletLondon, o.Left)),
                    (this.Description = t),
                    (this._selectedSprite = new l("commonmenu", "gradient_nav", new u(0, 0), new m(431, 38))),
                    (this._badgeLeft = new l("commonmenu", "", new u(0, 0), new m(40, 40))),
                    (this._badgeRight = new l("commonmenu", "", new u(0, 0), new m(40, 40))),
                    (this._labelText = new p("", new u(0, 0), 0.35, a.White, 0, o.Right));
            }
            get Text() {
            ...
            SetVerticalPosition(e) {
                (this._rectangle.pos = new u(this.Offset.X, e + 144 + this.Offset.Y)),
                    (this._selectedSprite.pos = new u(0 + this.Offset.X, e + 144 + this.Offset.Y)),
                    (this._text.pos = new u(8 + this.Offset.X, e + 147 + this.Offset.Y)),
                    (this._badgeLeft.pos = new u(0 + this.Offset.X, e + 142 + this.Offset.Y)),
                    (this._badgeRight.pos = new u(385 + this.Offset.X, e + 142 + this.Offset.Y)),
                    (this._labelText.pos = new u(420 + this.Offset.X, e + 148 + this.Offset.Y));
            }
            addEvent(e, ...t) {
            ...
            Draw() {
                (this._rectangle.size = new m(431 + this.Parent.WidthOffset, 38)),
                    ...
                    this.Hovered && !this.Selected && ((this._rectangle.color = new a(255, 255, 255, 20)), this._rectangle.Draw()),
                    (this._selectedSprite.color = this.Selected ? this.HighlightedBackColor : this.BackColor),
                    this._selectedSprite.Draw(),
                    (this._text.color = this.Enabled ? (this.Selected ? this.HighlightedForeColor : this.ForeColor) : new a(163, 159, 148)),
                    this.LeftBadge != h.None
                        ? ((this._text.pos = new u(35 + this.Offset.X, this._text.pos.Y)),
                          ...
                          (this._badgeLeft.color = this.IsBagdeWhiteSprite(this.LeftBadge) ? (this.Enabled ? (this.Selected ? this.HighlightedForeColor : this.ForeColor) : new a(163, 159, 148)) : a.White),
                          this._badgeLeft.Draw())
                        : (this._text.pos = new u(8 + this.Offset.X, this._text.pos.Y)),
                    this.RightBadge != h.None &&
                        ((this._badgeRight.pos = new u(385 + this.Offset.X + this.Parent.WidthOffset, this._badgeRight.pos.Y)),
                        ...
                        (this._badgeRight.color = this.IsBagdeWhiteSprite(this.RightBadge) ? (this.Enabled ? (this.Selected ? this.HighlightedForeColor : this.ForeColor) : new a(163, 159, 148)) : a.White),
                        this._badgeRight.Draw()),
                    this.RightLabel &&
                        "" !== this.RightLabel &&
                        ((this._labelText.pos = new u(420 + this.Offset.X + this.Parent.WidthOffset, this._labelText.pos.Y)),
                        (this._labelText.caption = this.RightLabel),
                        (this._labelText.color = this._text.color = this.Enabled ? (this.Selected ? this.HighlightedForeColor : this.ForeColor) : new a(163, 159, 148)),
        ...
        class w extends I {
            ...
            Draw() {
                ...
                this.Selected && e ? (this._checkedSprite.TextureName = this.Checked ? "shop_box_tickb" : "shop_box_blankb") : (this._checkedSprite.TextureName = this.Checked ? "shop_box_tick" : "shop_box_blank"),
                    (this._checkedSprite.color = this.Enabled ? (this.Selected && !e ? this.HighlightedForeColor : this.ForeColor) : new a(163, 159, 148)),
        ...
        class M extends I {
            constructor(e, t = "", s = new S([]), i = 0) {
                ...
                (this.Collection = s.getListItems()),
                    (this.Index = i),
                    (this._arrowLeft = new l("commonmenu", "arrowleft", new u(110, 105), new m(30, 30))),
                    (this._arrowRight = new l("commonmenu", "arrowright", new u(280, 105), new m(30, 30))),
                    (this._itemText = new p("", new u(290, 104), 0.35, a.White, r.ChaletLondon, o.Right));
            }
            get Collection() {
            ...
            SetVerticalPosition(e) {
                (this._arrowLeft.pos = new u(300 + this.Offset.X + this.Parent.WidthOffset, 147 + e + this.Offset.Y)),
                    (this._arrowRight.pos = new u(400 + this.Offset.X + this.Parent.WidthOffset, 147 + e + this.Offset.Y)),
                    (this._itemText.pos = new u(300 + this.Offset.X + this.Parent.WidthOffset, e + 147 + this.Offset.Y)),
            ...
            Draw() {
                ...
                (this._itemText.color = this.Enabled ? (this.Selected ? this.HighlightedForeColor : this.ForeColor) : new a(163, 159, 148)),
                    ...
                    (this._arrowLeft.color = this.Enabled ? (this.Selected ? this.HighlightedForeColor : this.ForeColor) : new a(163, 159, 148)),
                    (this._arrowRight.color = this.Enabled ? (this.Selected ? this.HighlightedForeColor : this.ForeColor) : new a(163, 159, 148)),
                    (this._arrowLeft.pos = new u(375 - t + this.Offset.X + this.Parent.WidthOffset, this._arrowLeft.pos.Y)),
                    this.Selected
                        ? (this._arrowLeft.Draw(), this._arrowRight.Draw(), (this._itemText.pos = new u(405 + this.Offset.X + this.Parent.WidthOffset, this._itemText.pos.Y)))
                        : (this._itemText.pos = new u(420 + this.Offset.X + this.Parent.WidthOffset, this._itemText.pos.Y)),
                    this._itemText.Draw();
            }
        }
        class O extends I {
            ...
            constructor(e, t, s, i = "", n = !1) {
                super(e, i);
                (this._items = t),
                    (this._arrowLeft = new l("commonmenutu", "arrowleft", new u(0, 105), new m(15, 15))),
                    (this._arrowRight = new l("commonmenutu", "arrowright", new u(0, 105), new m(15, 15))),
                    (this._rectangleBackground = new f(new u(0, 0), new m(150, 9), new a(4, 32, 57, 255))),
                    (this._rectangleSlider = new f(new u(0, 0), new m(75, 9), new a(57, 116, 200, 255))),
                    (this._rectangleDivider = new f(new u(0, 0), new m(2.5, 20), n ? a.WhiteSmoke : a.Transparent)),
                    (this.Index = s);
            }
            SetVerticalPosition(e) {
                (this._rectangleBackground.pos = new u(250 + this.Offset.X + this.Parent.WidthOffset, e + 158.5 + this.Offset.Y)),
                    (this._rectangleSlider.pos = new u(250 + this.Offset.X + this.Parent.WidthOffset, e + 158.5 + this.Offset.Y)),
                    (this._rectangleDivider.pos = new u(323.5 + this.Offset.X + this.Parent.WidthOffset, e + 153 + this.Offset.Y)),
                    (this._arrowLeft.pos = new u(235 + this.Offset.X + this.Parent.WidthOffset, 155.5 + e + this.Offset.Y)),
                    (this._arrowRight.pos = new u(400 + this.Offset.X + this.Parent.WidthOffset, 155.5 + e + this.Offset.Y)),
                    super.SetVerticalPosition(e);
            }
            IndexToItem(e) {
            ...
            Draw() {
                super.Draw(),
                    (this._arrowLeft.color = this.Enabled ? (this.Selected ? a.Black : a.WhiteSmoke) : new a(163, 159, 148)),
                ...
                (this._rectangleSlider.pos = new u(250 + this.Offset.X + e + +this.Parent.WidthOffset, this._rectangleSlider.pos.Y)),
        ...
        class T {
            constructor(e, t, s, i, n) {
                (this.counterPretext = ""),
                    ...
                    (this._mainMenu = new D(new u(0, 0), new m(700, 500), new a(0, 0, 0, 0))),
                    (this._logo = new l(this.spriteLibrary, this.spriteName, new u(0 + this.offset.X, 0 + this.offset.Y), new m(431, 107))),
                    this._mainMenu.addItem((this._title = new p(this.title, new u(215 + this.offset.X, 20 + this.offset.Y), 1.15, new a(255, 255, 255), 1, o.Centered))),
                    "" !== this.subtitle &&
                        (this._mainMenu.addItem(new f(new u(0 + this.offset.X, 107 + this.offset.Y), new m(431, 37), new a(0, 0, 0, 255))),
                        this._mainMenu.addItem((this._subtitle = new p(this.subtitle, new u(8 + this.offset.X, 110 + this.offset.Y), 0.35, new a(255, 255, 255), 0, o.Left))),
                        this.subtitle.startsWith("~") && (this.counterPretext = this.subtitle.substr(0, 3)),
                        (this._counterText = new p("", new u(425 + this.offset.X, 110 + this.offset.Y), 0.35, new a(255, 255, 255), 0, o.Right)),
                        (this.extraOffset += 37)),
                    (this._upAndDownSprite = new l("commonmenu", "shop_arrows_upanddown", new u(190 + this.offset.X, 147 + 37 * (this.MaxItemsOnScreen + 1) + this.offset.Y - 37 + this.extraOffset), new m(50, 50))),
                    (this._extraRectangleUp = new f(new u(0 + this.offset.X, 144 + 38 * (this.MaxItemsOnScreen + 1) + this.offset.Y - 37 + this.extraOffset), new m(431, 18), new a(0, 0, 0, 200))),
                    (this._extraRectangleDown = new f(new u(0 + this.offset.X, 162 + 38 * (this.MaxItemsOnScreen + 1) + this.offset.Y - 37 + this.extraOffset), new m(431, 18), new a(0, 0, 0, 200))),
                    (this._descriptionBar = new f(new u(this.offset.X, 123), new m(431, 4), a.Black)),
                    (this._descriptionRectangle = new l("commonmenu", "gradient_bgd", new u(this.offset.X, 127), new m(431, 30))),
                    (this._descriptionText = new p("Description", new u(this.offset.X + 5, 125), 0.35, new a(255, 255, 255, 255), r.ChaletLondon, o.Left)),
                    (this._background = new l("commonmenu", "gradient_bgd", new u(this.offset.X, 144 + this.offset.Y - 37 + this.extraOffset), new m(290, 25))),
            ...
            RecalculateDescriptionPosition() {
                (this._descriptionBar.pos = new u(this.offset.X, 112 + this.extraOffset + this.offset.Y)),
                    (this._descriptionRectangle.pos = new u(this.offset.X, 112 + this.extraOffset + this.offset.Y)),
                    (this._descriptionText.pos = new u(this.offset.X + 8, 118 + this.extraOffset + this.offset.Y)),
                ...
                e > this.MaxItemsOnScreen + 1 && (e = this.MaxItemsOnScreen + 2),
                    (this._descriptionBar.pos = new u(this.offset.X, 38 * e + this._descriptionBar.pos.Y)),
                    (this._descriptionRectangle.pos = new u(this.offset.X, 38 * e + this._descriptionRectangle.pos.Y)),
                    (this._descriptionText.pos = new u(this.offset.X + 8, 38 * e + this._descriptionText.pos.Y));
            }
            SetMenuWidthOffset(e) {
                if (
                    ((this.WidthOffset = e),
                    null != this._logo && (this._logo.size = new m(431 + this.WidthOffset, 107)),
                    (this._mainMenu.Items[0].pos = new u((this.WidthOffset + this.offset.X + 431) / 2, 20 + this.offset.Y)),
                    this._counterText && (this._counterText.pos = new u(425 + this.offset.X + e, 110 + this.offset.Y)),
            ...
            AddItem(e) {
                this._justOpened && (this._justOpened = !1),
                    ...
                    (e.Parent = this),
                    e.SetVerticalPosition(25 * this.MenuItems.length - 37 + this.extraOffset),
            ...
            SelectItem() {
                ...
                this.MenuItems[this.CurrentSelection] instanceof w
                    ? ((e.Checked = !e.Checked), R.PlaySound(this.AUDIO_SELECT, this.AUDIO_LIBRARY), this.onCheckboxChange.emit(e, e.Checked))
                    : (R.PlaySound(this.AUDIO_SELECT, this.AUDIO_LIBRARY),
                      this.onItemSelect.emit(e, this.CurrentSelection),
                      this.Children.has(e) && ((this.Visible = !1), (this.Children.get(e).Visible = !0), this.onMenuChange.emit(this.Children.get(e), !0))),
                    e.fireEvent();
            }
            ...
            ProcessMouse() {
                ...
                this.MenuItems.length > this.MaxItemsOnScreen + 1 && (e = this._maxItem),
                    this.IsMouseInBounds(new u(0, 0), new m(30, 1080)) && this.MouseEdgeEnabled
                        ...
                        : this.IsMouseInBounds(new u(this.GetScreenResolutionMantainRatio().Width - 30, 0), new m(30, 1080)) && this.MouseEdgeEnabled
                        ...
                        if (((r.Hovered = !0), mp.game.controls.isControlJustPressed(0, 24) || mp.game.controls.isDisabledControlJustPressed(0, 24)))
                            if (r.Selected && r.Enabled)
                                ...
                                r.Selected
                                    ...
                                    : ((this.CurrentSelection = i), R.PlaySound(this.AUDIO_UPDOWN, this.AUDIO_LIBRARY), this.onIndexChange.emit(this.CurrentSelection), this.SelectItem());
                    } else r.Hovered = !1;
                    t++;
                }
            ...
            GoBack() {
                R.PlaySound(this.AUDIO_BACK, this.AUDIO_LIBRARY),
                    (this.Visible = !1),
                    null != this.ParentMenu && ((this.ParentMenu.Visible = !0), (this.ParentMenu._justOpened = !0), this.onMenuChange.emit(this.ParentMenu, !1)),
                ...
                if (this.Visible) {
                    ...
                    if (this.MenuItems.length <= this.MaxItemsOnScreen + 1) {
                        ...
                        if (
                            ...
                            (this._upAndDownSprite.pos = new u(190 + this.offset.X + this.WidthOffset / 2, 147 + 37 * (this.MaxItemsOnScreen + 1) + this.offset.Y - 37 + this.extraOffset)),
