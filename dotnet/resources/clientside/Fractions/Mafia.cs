...
namespace ULife.Fractions
{
        ...
        {
            { 10, new Vector3(1392.066, 1153.032, -113.3233) }, //Колшейп вход в Мафию
            { 11, new Vector3(-113.4213, 985.761, -234.6341) }, //Колшейп вход в Русскую мафию
            { 12, new Vector3(-1549.331, -90.05454, -53.80917) }, //Колшейп вход в мафию Якудзу
            { 13, new Vector3(-1805.049, 438.1696, -127.5874) }, //Колшейп вход в Армянскую Мафию
        };
            public static Dictionary<int, Vector3> ExitPoints = new Dictionary<int, Vector3>()
        {
            { 10, new Vector3(1396.62, 1142.823, 83.24014) }, //Колшейп выход из мафии
            { 11, new Vector3(-123.8163, 975.3881, 58.63158) }, //Колшейп выход из Русской мафии
            { 12, new Vector3(-1550.298, -94.81767, -193.2058) }, //Колшейп выход из мафии Якудзы
            { 13, new Vector3(-1812.82, 466.4906, -185.7867) }, //Колшейп выход из Армянской мафии
        };
