...
namespace ULife.Fractions
{
    class Merryweather : Script
    {
        ...
        {
            new Vector3(781.4484, 1296.827, -361.5), // Колшэйп входа в бункер
            new Vector3(781.4484, 1296.827, -361.5), // Колшэйп изнутри интерьера для телепорта наверх
            new Vector3(781.4484, 1296.827, -361.5), // Колшэйп входа на другой этаж
            new Vector3(781.4484, 1296.827, -361.5), // Колшэйп изнутри этажа, чтобы вернуться назад
        };
        ...
        public static void interactPressed(Player player, int interact)
        {
            switch (interact)
            {
                ...
                case 85:
                    ...
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.MapUp, "Du bist kein Mitglied von Merryweather", 3000);
                        return;
                    }
