...
namespace ULife.Houses
{
    ...
    class FurnitureManager : Script
    {
        ...
        {
            { "Waffentresor", "prop_ld_int_safe_01" },
            { "Wäschesschrank", "prop_rub_cabinet02" },
            { "Schrank", "prop_rub_cabinet01" },
        };
        ...
        public static void newFurniture(int id, string name)
        {
            ...
            if (name == "Wäscheschrank" || name == "Waffentresor" || name == "Schrank") data = new List<nItem>();
