...
namespace ULife.Core
{
    class VehicleManager : Script
    {
        ...
        public static List<VehicleHash> medKitsTransporters = new List<VehicleHash>()
        {
        ...
        public Dictionary<uint, string> vehiceLicenseCategory = new Dictionary<uint, string>
        {
            {NAPI.Util.GetHashKey("faggio"), "A" },
            {NAPI.Util.GetHashKey("mazdarx7"), "B" },
            {NAPI.Util.GetHashKey("evo10"), "B" },
            {NAPI.Util.GetHashKey("Neon"), "B" },
            {NAPI.Util.GetHashKey("equus15"), "B" },
            {NAPI.Util.GetHashKey("lumma750"), "B" },
            {NAPI.Util.GetHashKey("16challenger"), "B" },
            {NAPI.Util.GetHashKey("m2f22"), "B" },
            {NAPI.Util.GetHashKey("370z"), "B" },
            {NAPI.Util.GetHashKey("Z419"), "B" },
            {NAPI.Util.GetHashKey("x5m"), "B" },
            {NAPI.Util.GetHashKey("lfa"), "B" },
            {NAPI.Util.GetHashKey("17m760i"), "B" },
            {NAPI.Util.GetHashKey("Shelbygt500"), "B" },
            {NAPI.Util.GetHashKey("mgt"), "B" },
            {NAPI.Util.GetHashKey("m5e60"), "B" },
            {NAPI.Util.GetHashKey("16charger"), "B" },
            {NAPI.Util.GetHashKey("gs350"), "B" },
            {NAPI.Util.GetHashKey("amarok"), "B" },
            {NAPI.Util.GetHashKey("tts"), "B" },
            {NAPI.Util.GetHashKey("lc200"), "B" },
            {NAPI.Util.GetHashKey("300srt8"), "B" },
            {NAPI.Util.GetHashKey("srt8"), "B" },
            {NAPI.Util.GetHashKey("m3f80"), "B" },
            {NAPI.Util.GetHashKey("x5m2016"), "B" },
            {NAPI.Util.GetHashKey("CLA45Sb"), "B" },
            {NAPI.Util.GetHashKey("mbc63s"), "B" },
            {NAPI.Util.GetHashKey("x6m"), "B" },
            {NAPI.Util.GetHashKey("vwtoua19c"), "B" },
            {NAPI.Util.GetHashKey("m4f82"), "B" },
            {NAPI.Util.GetHashKey("CLS63S"), "B" },
            {NAPI.Util.GetHashKey("gtr"), "B" },
            {NAPI.Util.GetHashKey("rs6"), "B" },
            {NAPI.Util.GetHashKey("gls63"), "B" },
            {NAPI.Util.GetHashKey("audirs7"), "B" },
            {NAPI.Util.GetHashKey("demonhawk"), "B" },
            {NAPI.Util.GetHashKey("e63s"), "B" },
            {NAPI.Util.GetHashKey("gle"), "B" },
            {NAPI.Util.GetHashKey("2019M5"), "B" },
            {NAPI.Util.GetHashKey("mlbrabus"), "B" },
            {NAPI.Util.GetHashKey("GMT900Escalade"), "B" },
            {NAPI.Util.GetHashKey("mgrantur2010"), "B" },
            {NAPI.Util.GetHashKey("sq72016"), "B" },
            {NAPI.Util.GetHashKey("g65amg"), "B" },
            {NAPI.Util.GetHashKey("velar"), "B" },
            {NAPI.Util.GetHashKey("DB905"), "B" },
            {NAPI.Util.GetHashKey("supragr"), "B" },
            {NAPI.Util.GetHashKey("brabus850"), "B" },
            {NAPI.Util.GetHashKey("i8"), "B" },
            {NAPI.Util.GetHashKey("G63"), "B" },
            {NAPI.Util.GetHashKey("c7"), "B" },
            {NAPI.Util.GetHashKey("rrsvr"), "B" },
            {NAPI.Util.GetHashKey("panamera17turbo"), "B" },
            {NAPI.Util.GetHashKey("amggt"), "B" },
            {NAPI.Util.GetHashKey("viper"), "B" },
            {NAPI.Util.GetHashKey("c8"), "B" },
            {NAPI.Util.GetHashKey("m850"), "B" },
            {NAPI.Util.GetHashKey("r8v10"), "B" },
            {NAPI.Util.GetHashKey("gt63s"), "B" },
            {NAPI.Util.GetHashKey("slsamg"), "B" },
            {NAPI.Util.GetHashKey("rrover17"), "B" },
            {NAPI.Util.GetHashKey("s63w222"), "B" },
            {NAPI.Util.GetHashKey("maybach"), "B" },
            {NAPI.Util.GetHashKey("bentayga17"), "B" },
            {NAPI.Util.GetHashKey("lhuracan"), "B" },
            {NAPI.Util.GetHashKey("urus"), "B" },
            {NAPI.Util.GetHashKey("rrwraith"), "B" },
            {NAPI.Util.GetHashKey("ff"), "B" },
            {NAPI.Util.GetHashKey("gt17"), "B" },
            {NAPI.Util.GetHashKey("SVJ63"), "B" },
            {NAPI.Util.GetHashKey("lambo770"), "B" },
            {NAPI.Util.GetHashKey("aperta"), "B" },
            {NAPI.Util.GetHashKey("p1"), "B" },
            {NAPI.Util.GetHashKey("chiron"), "B" },
            {NAPI.Util.GetHashKey("zaz968m"), "B" },
            {NAPI.Util.GetHashKey("vaz2106"), "B" },
            {NAPI.Util.GetHashKey("vaz21099"), "B" },
            {NAPI.Util.GetHashKey("volga"), "B" },
            {NAPI.Util.GetHashKey("vaz2113"), "B" },
            {NAPI.Util.GetHashKey("priora"), "B" },
            {NAPI.Util.GetHashKey("passatb3"), "B" },
            {NAPI.Util.GetHashKey("volvo850r"), "B" },
            {NAPI.Util.GetHashKey("civic"), "B" },
            {NAPI.Util.GetHashKey("vesta"), "B" },
            {NAPI.Util.GetHashKey("bmwe34"), "B" },
            {NAPI.Util.GetHashKey("bmwe36"), "B" },
            {NAPI.Util.GetHashKey("w210"), "B" },
            {NAPI.Util.GetHashKey("bmwe38"), "B" },
            {NAPI.Util.GetHashKey("w140"), "B" },
            {NAPI.Util.GetHashKey("V60"), "B" },
            {NAPI.Util.GetHashKey("markii"), "B" },
            {NAPI.Util.GetHashKey("bmwe65"), "B" },
            {NAPI.Util.GetHashKey("x5e53"), "B" },
            {NAPI.Util.GetHashKey("focusrs"), "B" },
            {NAPI.Util.GetHashKey("subaruwrx"), "B" },
            {NAPI.Util.GetHashKey("camry55"), "B" },
            {NAPI.Util.GetHashKey("a8lw12"), "B" },
            {NAPI.Util.GetHashKey("rs4avant"), "B" },
            {NAPI.Util.GetHashKey("taxi"), "B" },
            {NAPI.Util.GetHashKey("towtruck"), "C" },
            {NAPI.Util.GetHashKey("airbus"), "C" },
            {NAPI.Util.GetHashKey("bus"), "C" },
            {NAPI.Util.GetHashKey("coach"), "C" },
            {NAPI.Util.GetHashKey("stockade"), "C" },
            {NAPI.Util.GetHashKey("phantom"), "C" },
            {NAPI.Util.GetHashKey("mule2"), "C" },
            {NAPI.Util.GetHashKey("mule"), "C" },
            {NAPI.Util.GetHashKey("phantom3"), "C" },
            {NAPI.Util.GetHashKey("youga"), "C" },
            {NAPI.Util.GetHashKey("youga2"), "C" },
            {NAPI.Util.GetHashKey("riot"), "C" },
            {NAPI.Util.GetHashKey("nspeedo"), "C" },
            {NAPI.Util.GetHashKey("pbus"), "C" },
        };
                    ...
                    if (NAPI.Data.GetEntityData(vehicle, "ACCESS") == "FRACTION")
                    {
                        if (NAPI.Data.GetEntityData(vehicle, "FRACTION") == 14 && vehicle.DisplayName == "Barracks")
                        {
                            ...
                            if ((fracid >= 1 && fracid <= 5) || (fracid >= 10 && fracid <= 13))
                            {
                                ...
                                {
                                    Notify.Send(player, NotifyType.Info, NotifyPosition.MapUp, $"Sie können zwischen 00:00 und 10:00 Uhr nicht in Ihr Auto einsteigen", 3000);
                                    return;
                                }
                                Notify.Send(player, NotifyType.Info, NotifyPosition.MapUp, $"Um den Motor zu starten, drücken Sie B", 3000);
                                return;
                            }
                            else if (fracid == 14)
                            {
                                ...
                                {
                                    Notify.Send(player, NotifyType.Error, NotifyPosition.MapUp, $"Sie haben keinen Zugriff auf diesen Transport", 3000);
        ...
        private static void callback_sellcar(Player player, Menu menu, Menu.Item item, string eventName, dynamic data)
        {
            ...
            Trigger.ClientEvent(player, "openInput", "Verkaufen Sie das Auto", "Preis eingeben", 7, "sellcar");
        }
        #endregion
        ...
        public static void ChangeVehicleDoors(Player player, Vehicle vehicle)
        {
            switch (NAPI.Data.GetEntityData(vehicle, "ACCESS"))
            {
                case "HOTEL":
                    ...
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.MapUp, $"Keine Tasten.", 3000);
                        return;
                    }
                    if (Core.VehicleStreaming.GetLockState(vehicle))
                    {
                        Core.VehicleStreaming.SetLockStatus(vehicle, false);
                        Notify.Send(player, NotifyType.Success, NotifyPosition.MapUp, $"Sie haben die Autotüren geöffnet", 3000);
                    }
                    else
                    {
                        Core.VehicleStreaming.SetLockStatus(vehicle, true);
                        Notify.Send(player, NotifyType.Success, NotifyPosition.MapUp, $"Sie haben die Autotüren geschlossen", 3000);
                    }
                    break;
                case "RENT":
        ...
        public static void onClientEvent(Player sender, string eventName, params object[] args)
        {
            switch (eventName)
            {
                ...
                case "engineCarPressed":
                    ...
                    {
                        Notify.Send(sender, NotifyType.Error, NotifyPosition.MapUp, $"Sie müssen sich auf dem Fahrersitz befinden", 3000);
                        return;
                    }
                    ...
                    if (NAPI.Data.HasEntitySharedData(vehicle, "PETROL") && (int)NAPI.Data.GetEntitySharedData(vehicle, "PETROL") <= 0)
                    {
                        Notify.Send(sender, NotifyType.Error, NotifyPosition.MapUp, $"Kraftstofftank leer", 3000);
                        return;
                    }
                    switch (NAPI.Data.GetEntityData(vehicle, "ACCESS"))
                    {
                        case "HOTEL":
                            ...
                            {
                                Notify.Send(sender, NotifyType.Error, NotifyPosition.MapUp, $"Keine Tasten.", 3000);
                                return;
                            }
                            if (Core.VehicleStreaming.GetEngineState(vehicle))
                            {
                                Core.VehicleStreaming.SetEngineState(vehicle, false);
                                Notify.Send(sender, NotifyType.Success, NotifyPosition.MapUp, $"Der Motor ist ausgeschaltet", 3000);
                            }
                            else
                            {
                                Core.VehicleStreaming.SetEngineState(vehicle, true);
                                Notify.Send(sender, NotifyType.Success, NotifyPosition.MapUp, $"Der Motor läuft", 3000);
                            }
                            break;
                        case "SCHOOL":
                        ...
                        case "beltCarPressed":
                            ...
                            if (!beltstate) Commands.RPChat("me", sender, "hat sich angeschnallt");
                            else Commands.RPChat("me", sender, "Verfolgt den Sicherheitsgurt");
                           break;
                        case "RENT":
                            if (NAPI.Data.GetEntityData(vehicle, "DRIVER") != sender && Main.Players[sender].AdminLVL < 3)
                            {
            ...
            try
            {
                ...
                switch (access)
                {
                    case "PERSONAL":
                        {
                            ...
                            Notify.Send(owner, NotifyType.Alert, NotifyPosition.MapUp, "Ihr Auto ist zerstört", 3000);
                    ...
                    case "WORK":
                        ...
                        if (player != null)
                        {
                            string paymentMsg = (player.GetData<int>("PAYMENT") == 0) ? "" : $"Sie haben einen Gehaltsscheck in {player.GetData<int>("PAYMENT")}$";
                            Notify.Send(player, NotifyType.Info, NotifyPosition.MapUp, "Ihr Arbeitsfahrzeug wurde zerstört. " + paymentMsg, 3000);
