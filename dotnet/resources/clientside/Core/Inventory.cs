...
namespace ULife.Core
{
    class nInventory : Script
    {
        public static Dictionary<int, string> ItemsNames = new Dictionary<int, string>
        {
            ...
            {137, "Schwereres Scharfschützengewehr" },
            {138, "DMR" },
            {139, "Barrett XM500" },
            {140, "Marksman Rifle Mk2" },
            {141, "Pump Shotgun" },
            {142, "SawnOff Shotgun" },
            {143, "Bullpup Schrotflinte" },
            {144, "Assault Shotgun" },
            {145, "Muskete" },
            ...
            {181, "Schlagstock"},
            {182, "Hammer"},
            {183, "Baseballschläger"},
            {184, "Brechstange"},
            {185, "Golfschläger"},
            {186, "Abgebrochene Flasche"},
            {187, "Dolch"},
            {188, "Axt"},
            {189, "Schlagring"},
            {190, "Machete"},
            ...
            {197, "Haftbombe"},
            {199, "Gasgranate"},
            {220, "Molotow-Cocktail"},
            {222, "Schneeball"},
            {223, "Ballon"},
            {224, "Rauchgranate"},
            {225, "IED"},
            {200, "Pistolen-Munition"},
            {201, "SMG-Munition" },
            {202, "Gewehr-Munition" },
            {203, "Sniper-Munition" },
            {204, "Schrotflinten-Munition" },
            {234, "Ernte" },
            {235, "Saatgut" },
        };
        ...
        public static Dictionary<ItemType, uint> ItemModels = new Dictionary<ItemType, uint>()
        {
            ...
            { ItemType.Apfel, NAPI.Util.GetHashKey("apa_mp_h_acc_fruitbowl_02") },
            ...
            { ItemType.Grenade, NAPI.Util.GetHashKey("w_ex_grenadefrag") },
            { ItemType.StickyBomb, NAPI.Util.GetHashKey("prop_bomb_01_s") },
            { ItemType.BZGas, NAPI.Util.GetHashKey("prop_gas_grenade") },
            { ItemType.Molotov, NAPI.Util.GetHashKey("w_ex_molotov") },
            { ItemType.Snowball, NAPI.Util.GetHashKey("w_ex_snowball") },
            { ItemType.Ball, NAPI.Util.GetHashKey("w_am_baseball") },
            { ItemType.SmokeGrenade, NAPI.Util.GetHashKey("w_ex_grenadesmoke") },
            { ItemType.PipeBomb, NAPI.Util.GetHashKey("w_ex_pipebomb") },
        ...
        public static Dictionary<ItemType, Vector3> ItemsPosOffset = new Dictionary<ItemType, Vector3>()
        {
            ...
            { ItemType.Chips, new Vector3(0, 0, -1) },
            ...
            { ItemType.Apfel, new Vector3(0, 0, -1) },
            ...
            { ItemType.Grenade, new Vector3(0, 0, -0.99) },
            { ItemType.StickyBomb, new Vector3(0, 0, -0.99) },
            { ItemType.BZGas, new Vector3(0, 0, -0.99) },
            { ItemType.Molotov, new Vector3(0, 0, -0.99) },
            { ItemType.Snowball, new Vector3(0, 0, -0.99) },
            { ItemType.Ball, new Vector3(0, 0, -0.99) },
            { ItemType.SmokeGrenade, new Vector3(0, 0, -0.99) },
            { ItemType.PipeBomb, new Vector3(0, 0, -0.99) },
        ...
        public static Dictionary<ItemType, Vector3> ItemsRotOffset = new Dictionary<ItemType, Vector3>()
        {
            ...
            { ItemType.Chips, new Vector3(90, 90, 0) },
            ...
            { ItemType.Grenade, new Vector3(90, 0, 0) },
            { ItemType.StickyBomb, new Vector3(90, 0, 0) },
            { ItemType.BZGas, new Vector3(90, 0, 0) },
            { ItemType.Molotov, new Vector3(90, 0, 0) },
            { ItemType.Snowball, new Vector3(90, 0, 0) },
            { ItemType.Ball, new Vector3(90, 0, 0) },
            { ItemType.SmokeGrenade, new Vector3(90, 0, 0) },
            { ItemType.PipeBomb, new Vector3(90, 0, 0) },
        ...
        public static Dictionary<ItemType, int> ItemsStacks = new Dictionary<ItemType, int>()
        {
            ...
            { ItemType.Grenade, 5 },
            { ItemType.StickyBomb, 5 },
            { ItemType.BZGas, 5 },
            { ItemType.Molotov, 5 },
            { ItemType.Snowball, 5 },
            { ItemType.Ball, 5 },
            { ItemType.SmokeGrenade, 5 },
            { ItemType.PipeBomb, 5 },
        ...
        public static List<ItemType> BombItems = new List<ItemType>()
        {
            ItemType.Grenade,
            ItemType.StickyBomb,
            ItemType.BZGas,
        ...
        public static Dictionary<ItemType, string> ItemEffects = new Dictionary<ItemType, string>()
        {
            { ItemType.Joint, "PPFilter" },
            { ItemType.Ephidrin, "PPFilter" },
        };
        public static Dictionary<ItemType, List<string>> ItemAnnimations = new Dictionary<ItemType, List<string>>()
        {
            { ItemType.Joint, new List<string>() {"amb@code_human_in_car_mp_actions@first_person@smoke@std@ds@base", "enter"}},
            { ItemType.Ephidrin, new List<string>() {"amb@code_human_in_car_mp_actions@first_person@smoke@std@ds@base", "enter"}},
       //     { ItemType.Zigarette, new List<string>() {"amb@code_human_in_car_mp_actions@first_person@smoke@std@ds@base", "enter"}},
        };

        public static Dictionary<ItemType, List<Vector3>> ItemAttachments = new Dictionary<ItemType, List<Vector3>>()
        {
            { ItemType.Joint, new List<Vector3>() { new Vector3(0, 0, 0.00), new Vector3(0.0, 0.0, -0.06) } },
            { ItemType.Ephidrin, new List<Vector3>() { new Vector3(0, 0, 0.00), new Vector3(0.0, 0.0, -0.06) } },
       //     { ItemType.Zigarette, new List<Vector3>() { new Vector3(0, 0, 0.00), new Vector3(0.0, 0.0, -0.06) } },
            { ItemType.Funk, new List<Vector3>() { new Vector3(0, 0, 0.00), new Vector3(0.0, 0.0, -0.06) } },
        ...
        {
            void createItem(string name, ItemType itemType, int itemStack = 10, string model = "apa_mp_h_acc_fruitbowl_02")
            {
                ItemsNames.Add((int) itemType, name);
                ItemModels.Add(itemType, NAPI.Util.GetHashKey(model));
                ItemsPosOffset.Add(itemType, new Vector3(0, 0, -1));
                ItemsRotOffset.Add(itemType, new Vector3());
                ItemsStacks.Add(itemType, itemStack);
            }

            // forrest.js
            createItem("Weintrauben", ItemType.Trauben, 20);
            createItem("Wein", ItemType.Wein, 10);
            createItem("Baum", ItemType.Holz, 10);
            createItem("Orange", ItemType.Orange, 20);
            createItem("Orangensaft", ItemType.Orangensaft, 10);
            createItem("Eisen", ItemType.Eisen, 16);
            createItem("Metallbarren", ItemType.Metalbarren, 8);
            createItem("Erdöl", ItemType.Erdöl, 32);
            createItem("Benzin", ItemType.Öl, 16);
            createItem("Apfelsaft", ItemType.Apfelsaft, 10);
            // forrest2.js
            createItem("Kröte", ItemType.Kröten, 20);
            createItem("Ephidrin", ItemType.Ephidrin, 10);
            createItem("Marihuana", ItemType.Marihuana, 20);
            createItem("Ein Gelenk", ItemType.Joint, 10, "prop_sh_joint_01");
            createItem("Hopfen", ItemType.Hopfen, 20);
            createItem("Samogon", ItemType.Schnaps, 10);

            createItem("Zigaretten", ItemType.Zigarette, 10, "prop_sh_joint_01");
            createItem("Wasser", ItemType.Wasser, 10);
            createItem("Donut", ItemType.Donut, 10);
            createItem("Kaffee", ItemType.Kaffee, 10);
            createItem("Ein Gummibärchen", ItemType.Gummibärchen, 10);
            createItem("Schinken", ItemType.Schinken, 10);
            createItem("Rose", ItemType.Rose, 10, "p_single_rose_s");
            createItem("Schwarze Rose", ItemType.SchwarzeRose, 10, "p_single_rose_s");
            createItem("Funk", ItemType.Funk, 1, "prop_cs_hand_radio");
            createItem("ATM Hacking Card", ItemType.ATMHackingCard, 1, "bkr_prop_fakeid_singledriverl");
            createItem("Diamanten", ItemType.Juwel, 100, "bkr_prop_fakeid_singledriverl");

            createItem("Koka blatt", ItemType.Kokablatt, 10, "bkr_prop_fakeid_singledriverl");
            createItem("Kokain", ItemType.Kokain, 10, "bkr_prop_fakeid_singledriverl");
            createItem("Aceton", ItemType.Aceton, 10, "bkr_prop_fakeid_singledriverl");
            createItem("Batterie", ItemType.Autobatterie, 10, "bkr_prop_fakeid_singledriverl");
            createItem("Lithium", ItemType.Lithium, 10, "bkr_prop_fakeid_singledriverl");
            createItem("Methamphetamin", ItemType.Crystal, 10, "bkr_prop_fakeid_singledriverl");

            //createItem("Rucksack", ItemType.ItemBox, 1, "p_michael_backpack_s"); // Do not change value 1, because it is special item which can can contain other items inside
        }
        ...
        public static void Add(Player player, nItem item)
        {
            try
            {
                if (item.Count == 0)
                {
                    ...
                    throw new Exception("Item count can't be 0");
                }

                int UUID = Main.Players[player].UUID;
                int index = FindIndex(UUID, item.Type);
                if (ClothesItems.Contains(item.Type) || WeaponsItems.Contains(item.Type) || item.Type == ItemType.CarKey || item.Type == ItemType.KeyRing || item.Type == ItemType.ItemBox)
                {
                    Items[UUID].Add(item);
        ...
        public static int TryAdd(Player Player, nItem item)
        {
            try
            {
                ...
                if (ClothesItems.Contains(item.Type) || item.Type == ItemType.CarKey || item.Type == ItemType.KeyRing || item.Type == ItemType.ItemBox)
                {
                    if (isFull(UUID))
                        return -1;
                }
                ...
                else if (BombItems.Contains(item.Type))
                {
                    if (index != -1)
                    {
        ...
        public static void Remove(Player player, nItem item)
        {
            try
            {
                ...
                if (ClothesItems.Contains(item.Type) || BombItems.Contains(item.Type) || WeaponsItems.Contains(item.Type) || MeleeWeaponsItems.Contains(item.Type) || item.Type == ItemType.BagWithDrill 
                    || item.Type == ItemType.BagWithMoney || item.Type == ItemType.CarKey || item.Type == ItemType.KeyRing || item.Type == ItemType.ItemBox)
                {
        ...
        #region SPECIAL
        public static List<nItem> FindItems(Player player, ItemType type)
        {
            List<nItem> items = Items[Main.Players[player].UUID];
        ...
        public static void ClearWithoutClothes(Player player)
        {
            try
            {
                ...
                foreach (nItem item in items)
                    if (ClothesItems.Contains(item.Type) || item.Type == ItemType.CarKey || item.Type == ItemType.KeyRing || item.Type == ItemType.ItemBox) upd.Add(item);
    ...
    class Items : Script
    {
        ...
        public static void onUse(Player player, nItem item, int index)
        {
            try
            {
                ...
                if (nInventory.ClothesItems.Contains(item.Type) && item.Type != ItemType.BodyArmor && item.Type != ItemType.Mask)
                {
                    ...
                    {
                        var error_gender = (clothesGender) ? "für Männer" : "Frauen";
                        Notify.Send(player, NotifyType.Error, NotifyPosition.MapUp, $"Es ist {error_gender} Kleidung", 3000);
                    ...
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.MapUp, "Das können Sie nicht verwenden.", 3000);
                        GUI.Dashboard.Close(player);
                        return;
                    }*/
                }

                if (nInventory.BombItems.Contains(item.Type))
                {
                    if (item.IsActive) //Если предмет в руках и мы нажимаем использовать то происходит код ниже, очистка анимации и руки
                    {
                        var wHash = Weapons.GetHash(item.Type.ToString());
                        Trigger.ClientEvent(player, "takeOffWeapon", (int)wHash);
                        Commands.RPChat("me", player, $"entfernt(а) {nInventory.ItemsNames[(int)item.Type]}");
                    }
                    else
                    {
                        var oldwItem = nInventory.Items[UUID].FirstOrDefault(i => (nInventory.BombItems.Contains(i.Type)) && i.IsActive); //Отвечает за серверную уюорку оружия из рук
                        if (oldwItem != null)
                        {
                            ...
                            Commands.RPChat("me", player, $"entfernt(а) {nInventory.ItemsNames[(int)oldwItem.Type]}");
                        }

                        var wHash = Weapons.GetHash(item.Type.ToString()); //Отвечает за перезарядку
                        ...
                        else //В нашем случае код ниже получение граныты в руки
                        {
                        ...
                        switch (item.Type)
                        {
                            case ItemType.Grenade:
                                ...
                                item.IsActive = true;
                                nInventory.Remove(player, ItemType.Grenade, 1);
                                GUI.Dashboard.Close(player);
                                break;

                            case ItemType.StickyBomb:
                                Commands.RPChat("me", player, $"достал(а) {nInventory.ItemsNames[(int)item.Type]}");
                                GameLog.Items($"player({Main.Players[player].UUID})", "use", Convert.ToInt32(item.Type), 1, $"{item.Data}");
                                item.IsActive = true;
                                nInventory.Remove(player, ItemType.StickyBomb, 1);
                                GUI.Dashboard.Close(player);
                                break;
                            case ItemType.BZGas:
                                Commands.RPChat("me", player, $"достал(а) {nInventory.ItemsNames[(int)item.Type]}");
                                GameLog.Items($"player({Main.Players[player].UUID})", "use", Convert.ToInt32(item.Type), 1, $"{item.Data}");
                                item.IsActive = true;
                                nInventory.Remove(player, ItemType.BZGas, 1);
                                GUI.Dashboard.Close(player);
                                break;
                            case ItemType.Molotov:
                                ...
                                GameLog.Items($"player({Main.Players[player].UUID})", "use", Convert.ToInt32(item.Type), 1, $"{item.Data}");
                                item.IsActive = true;
                                nInventory.Remove(player, ItemType.Molotov, 1);
                                GUI.Dashboard.Close(player);
                                break;
                            case ItemType.Snowball:
                                ...
                                GameLog.Items($"player({Main.Players[player].UUID})", "use", Convert.ToInt32(item.Type), 1, $"{item.Data}");
                                item.IsActive = true;
                                nInventory.Remove(player, ItemType.Snowball, 1);
                                GUI.Dashboard.Close(player);
                                break;
                            case ItemType.Ball:
                                Commands.RPChat("me", player, $"достал(а) {nInventory.ItemsNames[(int)item.Type]}");
                                GameLog.Items($"player({Main.Players[player].UUID})", "use", Convert.ToInt32(item.Type), 1, $"{item.Data}");
                                item.IsActive = true;
                                nInventory.Remove(player, ItemType.Ball, 1);
                                GUI.Dashboard.Close(player);
                                break;
                            case ItemType.SmokeGrenade:
                                ...
                                GameLog.Items($"player({Main.Players[player].UUID})", "use", Convert.ToInt32(item.Type), 1, $"{item.Data}");
                                item.IsActive = true;
                                nInventory.Remove(player, ItemType.SmokeGrenade, 1);
                                GUI.Dashboard.Close(player);
                                break;
                            case ItemType.PipeBomb:
                                Commands.RPChat("me", player, $"достал(а) {nInventory.ItemsNames[(int)item.Type]}");
                                GameLog.Items($"player({Main.Players[player].UUID})", "use", Convert.ToInt32(item.Type), 1, $"{item.Data}");
                                item.IsActive = true;
                                nInventory.Remove(player, ItemType.PipeBomb, 1);
                                GUI.Dashboard.Close(player);
                                break;
                        }
                ...
                if (nInventory.WeaponsItems.Contains(item.Type) || nInventory.MeleeWeaponsItems.Contains(item.Type)) // 
                {
                    ...
                    else
                    {
                        ...
                        if (oldwItem != null)
                        {
                            ...
                            oldwItem.IsActive = false;
                            GUI.Dashboard.Update(player, oldwItem, nInventory.Items[UUID].IndexOf(oldwItem));
                            Notify.Send(player, NotifyType.Success, NotifyPosition.MapUp, $"Sie haben eine Waffe ausgerüstet", 3000); 
                        }
                        ...
                        Weapons.RemoteEvent_changeWeapon(player, 0);
                ...
                if (nInventory.AlcoItems.Contains(item.Type))
                {
                    ...
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.MapUp, $"Sie sind zu betrunken, um noch eine Flasche zu öffnen", 3000);
                        return;
                    }
                ...
                // Animations
                if (nInventory.ItemAnnimations.ContainsKey(item.Type))
                {

                    Main.OnAntiAnim(player);
                    player.PlayAnimation(nInventory.ItemAnnimations[item.Type][0], nInventory.ItemAnnimations[item.Type][1], 49);
                    NAPI.Task.Run(() => {
                        try
                        {
                            if (player != null)
                ...
                // Attachments
                if (nInventory.ItemAttachments.ContainsKey(item.Type))
                {
                    BasicSync.AttachObjectToPlayer(player, nInventory.ItemModels[item.Type], 57005, nInventory.ItemAttachments[item.Type][0], nInventory.ItemAttachments[item.Type][1]);
                    NAPI.Task.Run(() => {
                        try
                        {
                            if (player != null)
                ...
                // Screen effects
                if (nInventory.ItemEffects.ContainsKey(item.Type))
                {
                    Trigger.ClientEvent(player, "startScreenEffect", nInventory.ItemEffects[item.Type], 300000, false); // Trigger.ClientEvent(player, "startScreenEffect", nInventory.ItemEffects[item.Type], player.GetData("RESIST_TIME") * 1000, false);
                ...
                switch (item.Type)
                {
                    ...
                    case ItemType.Glasses:
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    Notify.Send(player, NotifyType.Error, NotifyPosition.MapUp, "Du kannst diese Brille nicht mit einer Maske tragen", 3000);
                                    return;
                                }
                    ...
                    case ItemType.Hat:
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    Notify.Send(player, NotifyType.Error, NotifyPosition.MapUp, "Du kannst das Kopfband nicht zusammen mit der Maske tragen", 3000);
                                    return;
                                }
                                var itemData = (string)item.Data;
                                var variation = Convert.ToInt32(itemData.Split('_')[0]);
                    ...
                    case ItemType.Accessories:
                        {
                            ...
                            else
                            {
                                ...
                                else if (Customization.AccessoryRHand[gender].ContainsKey(variation))
                                {
                                    ...
                                    {
                                        Notify.Send(player, NotifyType.Error, NotifyPosition.MapUp, "Beide Hände sind beschäftigt", 3000);
                                        return;
                                    }
                                }
                                else 
                                {
                                    Notify.Send(player, NotifyType.Error, NotifyPosition.MapUp, "Die linke Hand ist beschäftigt und niemand trägt rechts eine Uhr", 3000);
                                    return;
                                }
                            }
                            return;
                    ...
                    case ItemType.Undershit:
                        {
                            ...
                            else
                            {
                                if (Customization.CustomPlayerData[Main.Players[player].UUID].Clothes.Top.Variation == Customization.EmtptySlots[gender][11])
                                {
                                    if (underwear.Top == -1)
                                    {
                                        Notify.Send(player, NotifyType.Error, NotifyPosition.MapUp, "Diese Kleidung kann nur unter dem Top getragen werden", 3000);
                                        return;
                                    }
                                ...
                                else
                                {
                                    ...
                                    if (nowTop != null)
                                    {
                                        ...
                                        {
                                            Notify.Send(player, NotifyType.Error, NotifyPosition.MapUp, "Dieses Kleidungsstück ist nicht mit Ihrem Oberkleidungsstück kompatibel", 3000);
                                            return;
                                        }
                    ...
                    case ItemType.KeyRing:
                        ...
                        GUI.Dashboard.OpenOut(player, items, "Schlüsselbund", 7);
                        return;
                    case ItemType.ItemBox:
                        // Show KeyRing

                        if (! (item.Data is List<nItem>))
                        {
                            if (item.Data is JArray)
                            {
                                item.Data = JsonConvert.DeserializeObject<List<nItem>>(Convert.ToString(item.Data));
                            }
                            else
                            {
                                item.Data = new List<nItem>();
                            }
                        }

                        // Get keyring items
                        List<nItem> keyRingItems = item.Data;

                        // Update player keyring
                        player.SetData("ITEMBOX", nInventory.Items[Main.Players[player].UUID].IndexOf(item));
                        // Open window with items
                        GUI.Dashboard.OpenOut(player, keyRingItems, "Rucksack", 9);
                        return;
                    ...
                    case ItemType.eCola:
                        ...
                        //
                        player.Health = (player.Health + 5 > 100) ? 100 : player.Health + 5;
                        // Commands.RPChat("me", player, $"getrunken {nInventory.ItemsNames[(int)item.Type]}");
                      //    Notify.Send(player, NotifyType.Success, NotifyPosition.MapUp, $"Sie haben Bier getrunken!", 3000);

                        break;
                    case ItemType.Wasser:
                        // For THIRST (40)
                        EatManager.AddWater(player, 25);
                        EatManager.AddEat(player, 5);
                        //
                        player.Health = (player.Health + 5 > 100) ? 100 : player.Health + 5;
                        // Commands.RPChat("me", player, $"getrunken {nInventory.ItemsNames[(int)item.Type]}");
                        //  Notify.Send(player, NotifyType.Success, NotifyPosition.MapUp, $"Sie haben Wasser getrunken!", 3000);

                        break;
                    case ItemType.Kaffee:
                        // For THIRST (35)
                        EatManager.AddWater(player, 15);
                        EatManager.AddEat(player, 5);
                        //
                        player.Health = (player.Health + 5 > 100) ? 100 : player.Health + 5;
                        // Commands.RPChat("me", player, $"getrunken {nInventory.ItemsNames[(int)item.Type]}");
                        //  Notify.Send(player, NotifyType.Success, NotifyPosition.MapUp, $"Sie haben Kaffee getrunken!", 3000);
                    ...
                    case ItemType.Apfel:
                        ...
                        break;
                    case ItemType.Funk:
                        player.TriggerEvent("Client:Funk:Open");
                        return;
                    case ItemType.ATMHackingCard:
                        return;
                    case ItemType.Kokablatt:
                        return;
                    case ItemType.Zigarette:
                        Main.OnAntiAnim(player);
                    ...
                    case ItemType.Burger:
                        ...
                        // Commands.RPChat("me", player, $"aß es {nInventory.ItemsNames[(int)item.Type]}");
                        // Notify.Send(player, NotifyType.Error, NotifyPosition.MapUp, $"Sie haben es gegessen!", 3000);
                        break;
                    ...
                    case ItemType.Pizza:
                        ...
                        player.Health = (player.Health + 7 > 100) ? 100 : player.Health + 7;
                    ...
                    case ItemType.Sandwich:
                        // FOR HUNGER (70)
                        EatManager.AddWater(player, -8);
                        EatManager.AddEat(player, 13);
                        //

                        player.Health = (player.Health + 3 > 100) ? 100 : player.Health + 3;
                    ...
                    case ItemType.Drugs:
                        if (!player.HasData("USE_DRUGS") || DateTime.Now > player.GetData<DateTime>("USE_DRUGS"))
                        {
                            ...
                            Trigger.ClientEvent(player, "startScreenEffect", "DrugsTrevorClownsFight", 180000, false);
                        ...
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.MapUp, $"Das können Sie jetzt nicht mehr verwenden.", 3000);
                            return;
                        }                      
                        break;
                    case ItemType.GasCan:
                        ...
                        {
                            //Notify.Send(player, NotifyType.Error, NotifyPosition.MapUp, $"Das Auto ist vollgetankt", 3000);
                            GUI.Dashboard.Close(player);
                            return;
                        }
                        fuel += 30;
                    ...
                    case ItemType.HealthKit:
                        ...
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.MapUp, $"Versuchen Sie es später noch einmal", 3000);
                            return;
                        }
                        break;
                    case ItemType.Lockpick:
                        ...
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.MapUp, $"Zur Zeit nicht verwendbar", 3000);
                            GUI.Dashboard.Close(player);
                            return;
                        }
                        player.SetData("LOCK_TIMER", Timers.StartOnce(10000, () => SafeMain.lockCrack(player, player.Name)));
                        //player.FreezePosition = true;
                        Trigger.ClientEvent(player, "showLoader", "Es ist ein Einbruch im Gange.", 1);
                        Notify.Send(player, NotifyType.Info, NotifyPosition.MapUp, $"Sie haben angefangen, die Tür aufzubrechen", 3000);
                        break;
                    case ItemType.ArmyLockpick:
                        if (!player.IsInVehicle || player.Vehicle.DisplayName != "Barracks")
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.MapUp, $"Sie müssen sich in einem militärischen Materialträger befinden", 3000);
                            return;
                        }
                        if (VehicleStreaming.GetEngineState(player.Vehicle))
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.MapUp, $"Das Auto ist bereits gestartet.", 3000);
                            return;
                        }
                        var lucky = new Random().Next(0, 5);
                        Log.Debug(lucky.ToString());
                        if (lucky == 5)
                            Notify.Send(player, NotifyType.Error, NotifyPosition.MapUp, $"Sie können die Fahrzeug nicht starten. Versuchen Sie es erneut.", 3000);
                        else
                        {
                            VehicleStreaming.SetEngineState(player.Vehicle, true);
                            Notify.Send(player, NotifyType.Success, NotifyPosition.MapUp, $"Sie waren in der Lage, das Auto zu starten", 3000);
                        }
                        break;
                    case ItemType.Present:
                        player.Health = (player.Health + 10 > 100) ? 100 : player.Health + 10;
                        Notify.Send(player, NotifyType.Success, NotifyPosition.JobSms, $"Sie haben das Geschenk geöffnet, und es enthielt:", 3000);
                        ...
                        if (types.Item1 <= 2)
                        {
                            ...
                            Notify.Send(player, NotifyType.Info, NotifyPosition.MapUp, $"{nInventory.TypesCounts[types.Item1]} EXP", 3000);

                            MoneySystem.Wallet.Change(player, nInventory.TypesCounts[types.Item2]);

                            Notify.Send(player, NotifyType.Info, NotifyPosition.MapUp, $"$ {nInventory.TypesCounts[types.Item2]}", 3000);
                        }
                        else
                        {
                            MoneySystem.Wallet.Change(player, nInventory.TypesCounts[types.Item1]);

                            Notify.Send(player, NotifyType.Info, NotifyPosition.MapUp, $"$ {nInventory.TypesCounts[types.Item1]}", 3000);
                            ...
                            Notify.Send(player, NotifyType.Info, NotifyPosition.MapUp, $"{nInventory.TypesCounts[types.Item2]} EXP", 3000);
                        }

                        Commands.RPChat("me", player, $"geöffnet(а) Geschenk {types.Item1} + {types.Item2}");
                        break;
                }
                nInventory.Remove(player, item.Type, 1);
                Notify.Send(player, NotifyType.Info, NotifyPosition.JobSms, $"Sie haben {nInventory.ItemsNames[item.ID]}", 3000);
                GameLog.Items($"player({Main.Players[player].UUID})", "use", Convert.ToInt32(item.Type), 1, $"{item.Data}");
                GUI.Dashboard.Close(player);
            }
            catch (Exception e)
        ...
        public static void onDrop(Player player, nItem item, dynamic data)
        {
            try
            {
                ...
                if (!nInventory.ClothesItems.Contains(item.Type) && !nInventory.WeaponsItems.Contains(item.Type) && item.Type != ItemType.CarKey && item.Type != ItemType.KeyRing && item.Type != ItemType.ItemBox)
                {
