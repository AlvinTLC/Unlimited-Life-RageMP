...
namespace NeptuneEvo.Core
{
    ...
    [ServerEvent(Event.ResourceStart)]
        ...
        public static void useInventory(Player player, int level)
        {
            ...
            if (player.GetData<bool>("ALLOWFISHING") == false || player.GetData<int>("ALLOWFISHING") == null)
            {
        ...
        public class Roding
        {
            ...
            public Roding(int id, Vector3 areapoint, float radius)
            {
                ...
                // Create blip
                //NAPI.Blip.CreateBlip(68, new Vector3(-1833.355, -1221.296, 13.01731), 0.75f, 26, "Рыбалка", 255, 0, true);
