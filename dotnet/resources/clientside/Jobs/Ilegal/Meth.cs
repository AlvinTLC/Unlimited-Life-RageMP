...
class Meth : Script
{
    ...
    public void onResourceStart()
    {
        ...
        NAPI.Blip.SetBlipName(temp_blip, "Colheita de Opium");
        ...
        foreach (var weed in MethList)
        {
            ...
            weed.textLabel = API.Shared.CreateTextLabel("~h~~g~-~y~Hojas de Coca~g~ -~w~~n~~n~Presione ~y~Y~w~ para recojer", new Vector3(weed.position.X, weed.position.Y, weed.position.Z - 0.4f), 11.0f, 0.3f, 4, new Color(255, 255, 255, 255), false, 0);
        }
