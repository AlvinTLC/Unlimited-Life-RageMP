...
namespace ULife.Jobs
{
    class Gopostal : Script
    {
            ...
            try
            {
                ...
                if (player.HasData("NEXTHOUSE") && player.HasData("HOUSEID") && NAPI.Data.GetEntityData(player, "NEXTHOUSE") == player.GetData<int>("HOUSEID"))
                {
                    ...
                    else
                    {
                        ...
                        Notify.Send(player, NotifyType.Warning, NotifyPosition.MapUp, $"Wenn du keine Pakete mehr hast, fahre zurück und besorge dir neue", 3000);
                    }
                }
            }
        ...
        public static void getGoPostalCar(Player player)
        {
            ...
            {
                Notify.Send(player, NotifyType.Error, NotifyPosition.MapUp, $"Du arbeitest nicht als Kurier", 3000);
                return;
            }
            ...
            Notify.Send(player, NotifyType.Info, NotifyPosition.MapUp, $"Du hast ein funktionierendes Fahrzeug", 3000);
