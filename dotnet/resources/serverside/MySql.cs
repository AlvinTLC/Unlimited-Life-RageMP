    ...
    public static class MySQL
    {
        ...
        public static void Init()
        {
            ...
            Connection = 
                ...
                $"Password={config.TryGet<string>("Password", "cYFzBvHXfONWTkyc1TqIDd1V7dLY1ZcmqexLTzJaRzUEYbwlMyDgeXVdqMOl7PFgDDyfpUb9uVQWsNbwZLkiwCVxhpPsmxvPKTG")};" +
                $"Database={config.TryGet<string>("DataBase", "project")};" +
